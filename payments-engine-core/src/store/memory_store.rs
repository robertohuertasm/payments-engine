...
pub struct MemoryStore {
    #[cfg(test)]
    pub deposits: RwLock<HashMap<TransactionId, Transaction>>,
    #[cfg(test)]
    pub accounts: RwLock<HashMap<ClientId, Account>>,
    #[cfg(test)]
    pub enable_upsert_account_failure: bool,
    #[cfg(not(test))]
...
impl MemoryStore {
    ...
    pub fn seeded(
        ...
        Self {
            ...
            #[cfg(test)]
            enable_upsert_account_failure: false,
        }
    }
